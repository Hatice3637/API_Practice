...
public class GetRequest09 extends GMIBankBaseURL {
     ...
     */
        ...
        assertEquals(expectedData.getUser().getLogin(),actualData.getUser().getLogin());//iç içe
        assertEquals(expectedData.getCountry().getName(),actualData.getCountry().getName());//iç içe
